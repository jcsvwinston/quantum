...
> v1.0.0, orbit v1.0.0; ver `versions.yaml`). Las SEIS fases (0–5) están
> cerradas — el sitio unificado de §5 está vivo en
> jcsvwinston.github.io/quantum desde la Fase 2 — y rige el régimen de
> majors en lockstep (QADR-0002). Queda abierto, como trabajo posterior al
> hito: el versionado de la instancia de docs de nucleus (primer snapshot
> al corte v1.0.0). Las tablas de estado de este documento reflejan el
> punto de partida de 2026-06-22, no el estado actual.
