# Archivo de sesiones del paraguas (2026-07-12 → 2026-09-02)

> Movido aquí desde el §3 de `.claude/commands/next-session.md` el 2026-09-05:
> el handoff pesaba 203 KB y 40 sesiones, y el arranque de sesión lo cargaba
> truncado. Esto es HISTORIA, no estado: se consulta con grep cuando una
> decisión vieja importa («¿por qué X?»), no se carga entera. El estado
> vigente vive en el §3 del handoff; las trampas del tren, en
> `scripts/train/README.md`; las decisiones, en `docs/adr/`.
