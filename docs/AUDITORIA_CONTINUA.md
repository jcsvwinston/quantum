...
| umbrella-release-assets | . | `bash scripts/check_release_assets.sh` | Una release del set que no publica su fichero de sumas firmado: la firma falló y la release salió igual. Único guard que pregunta a la red. |
