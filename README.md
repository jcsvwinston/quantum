...
| **Orbit** | Admin — monta sobre Nucleus | `github.com/jcsvwinston/orbit` (+ cinco módulos hermanos, [tabla en §Orbit](#orbit--admin--submódulo-orbit-multi-módulo)) | `v1.9.0` | [`orbit/`](orbit) | No (requiere Nucleus) |
...
| Módulo | Rol | Versión |
|---|---|---|
| [`orbit/`](orbit) (raíz) | Panel de admin in-process montado en la app Nucleus. | `v1.9.0` |
...
| [`orbit/server`](orbit/server) | Binario de servidor de admin independiente que recibe esos eventos y sirve la UI. | `v0.11.0` |
