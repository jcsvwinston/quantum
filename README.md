...
|---|---|---|---|---|---|
| **Nucleus** | Framework web — el anfitrión | `github.com/jcsvwinston/nucleus` | `v1.20.1` | [`nucleus/`](nucleus) | Sí (base de apps) |
| **Quark** | ORM — la capa de datos | `github.com/jcsvwinston/quark` | `v1.7.0` | [`quark/`](quark) | **Sí, en cualquier app Go** |
| **Orbit** | Admin — monta sobre Nucleus | `github.com/jcsvwinston/orbit` (+ `/proto`, `/agent`, `/server`) | `v1.8.10` | [`orbit/`](orbit) | No (requiere Nucleus) |

Módulos de integración (repo orbit, opt-in; son los que materializan el puente quark↔orbit):

| Módulo | Rol | Versión |
|---|---|---|
| `github.com/jcsvwinston/orbit/quarkbridge` | Publica los statements de Quark en el feed vivo de Orbit | `v0.4.7` |
| `github.com/jcsvwinston/orbit/quarkdatasource` | Expone los modelos Quark en el Data Studio de Orbit | `v0.2.15` |
