...
| **Orbit** | Admin — monta sobre Nucleus | `github.com/jcsvwinston/orbit` (+ cinco módulos hermanos, [tabla en §Orbit](#orbit--admin--submódulo-orbit-multi-módulo)) | `v1.11.0` | [`orbit/`](orbit) | No (requiere Nucleus) |
...
| Módulo | Rol | Versión |
|---|---|---|
| [`orbit/`](orbit) (raíz) | Panel de admin in-process montado en la app Nucleus. | `v1.11.0` |
| [`orbit/proto`](orbit/proto) | Contrato Connect-RPC + stubs generados (Go y TypeScript). | `v0.5.0` |
| [`orbit/agent`](orbit/agent) | Agente in-process que embebe en cada proceso del framework y envía eventos a un servidor de admin por un stream bidi. | `v0.8.0` |
| [`orbit/server`](orbit/server) | Binario de servidor de admin independiente que recibe esos eventos y sirve la UI. | `v0.13.0` |
| [`orbit/quarkbridge`](orbit/quarkbridge) | Publica los statements de Quark en el feed vivo de Orbit | `v1.9.2` |
| [`orbit/quarkdatasource`](orbit/quarkdatasource) | Expone los modelos Quark en el Data Studio de Orbit | `v1.9.3` |
